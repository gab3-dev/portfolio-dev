...
export default function Home() {
  return (
    <>
      <main
        className={
          berkleyFont.className +
          "flex flex-col gap-[32px] row-start-2 sm:items-start"
        }
      >
        ...
        >
          Estes sites foram redesenhados buscando um design mais moderno, com
          cantos arredondados, novos estilos de fonte, maior contraste entre
          cores e melhor responsividade.
        </Typography>
        <MainMacbookMockup>
          <MainImageComparison
